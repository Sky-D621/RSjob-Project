...
from services.analysis_service import perform_change_detection
...
@change_detection_bp.route('/upload_and_analyze_metrics', methods=['POST'])
...
@change_detection_bp.route('/predict', methods=['POST'])
def predict_change_detection():
    ...
    analysis_result = perform_change_detection(path_a, path_b, predictor)
